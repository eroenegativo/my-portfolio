...
<VueSlickCarousel v-bind="settings">
    <div class="slide">
      ...
      <p class="slide-paragraph">responsive webpages are built to target a particular screen size and to be used oon any device</p>
    </div>
    <div class="slide">
      ...
      <h6>Prototyping</h6>
      <p class="slide-paragraph">The process of quickly putting together a working model (a prototype) in order to test various aspects of a design, illustrate ideas or features and gather early user feedback. Prototyping is often treated as an integral part of the system design processs</p>
    </div>
    <div class="slide">
